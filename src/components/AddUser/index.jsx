  ...
  return (
    <Fragment>
      <Container>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-outline mb-4">
                  ...
                  <input
                    ...
                    maxLength={254}
                    className="form-control"
                    placeholder="Podaj adres email użytkownika"
                  />
                </div>
                  ...
                  <div className="form-check">
                    <label className="form-check-label" htmlFor="administrator">
                      ...
                      <input
                        ...
                        name="roleName"
                        id="administrator"
                        checked={roleName === "Administrator"}
                        onChange={handleChange}
                      />
                    </label>
                  </div>
        ...
        <Popup
          component={<CopyPassword data={data} />}
          trigger={buttonPopup}
