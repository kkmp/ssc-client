...
const NavBar = (id) => {
  ...
  return (
    <Fragment>
      <AppBar position="sticky">
        <StyledToolbar>
          ...
          <div>
            ...
            >
              <ListItem>
                <ListItemButton onClick={handleClose} href="/addPatient">
                  Dodaj pacjenta
                </ListItemButton>
              </ListItem>
              <ListItem>
                <ListItemButton onClick={() => setButtonAddPopup(true)}>
                  Zmień hasło
                </ListItemButton>
              </ListItem>
              <ListItem>
                <MenuItem onClick={handleClose} href="/Logout">
                  Wyloguj się
                </MenuItem>
              </ListItem>
            </Menu>
      ...
      <Box>
        <Popup
          component={<ChangePasswordOnDemand id={id} />}
