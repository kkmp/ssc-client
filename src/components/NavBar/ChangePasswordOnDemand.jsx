...
const ChangePasswordOnDemand = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const callback = (response) => {
          toast.success("Zmieniono hasło", { position: toast.POSITION.BOTTOM_RIGHT });
