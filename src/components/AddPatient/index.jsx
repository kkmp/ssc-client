...
const AddPatient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!citizenship.value) {
      setError({
        errors: { message: ["Aby dodać, należy wybrać obywatelstwo"] },
      });
      return;
    }
                ...
                >
                  <Box minWidth={"250px"}>
                    <div className="form-outline mb-4">
                      <label className="form-label" htmlFor="pesel">
                        Numer PESEL
                      </label>
                      <RequiredComponent />
                      <input
                        ...
                        placeholder="Podaj numer PESEL pacjenta"
                      />
                    </div>
                    ...
                    <div id="radio-group" className="form-outline mb-4">
                      <label className="form-label" htmlFor="radio-group">
                        Płeć
                      </label>
                      <RequiredComponent />
                      ...
                      {citizenshipsOptions ? (
                        <div className="form-outline">
                          <Select
                            ...
                            name="citizenship"
                            required
                            placeholder="Wybierz obywatelstwo"
                            value={citizenship}
