...
const TreatmentDiseaseCourses = (id) => {
  ...
  const handleChange = async () => {
    ...
    const url =
      "/api/TreatmentDiseaseCourse/showTreatmentDiseaseCourses/" + id.id;
  ...
  return error != null ? (
    ...
    <Fragment>
          ...
          <TableBody>
            {data != null ? (
              <Paginate
                ...
                data={data.map((treatmentDiseaseCourse) => (
                  <TreatmentDiseaseCourse
                    key={treatmentDiseaseCourse.id}
                    data={treatmentDiseaseCourse}
                    onClick={onClick}
                  />
                ))}
              />
      ...
      <Popup
        component={
          <AddTreatmentDiseaseCourse onSubmit={handleChange} id={id} />
        }
